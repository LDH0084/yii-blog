...
<div class="inner-container" style="margin-top: 50px;">
    ...
    <div class="form-group">
        ...
        <div class="controls col-sm-9 col-md-11">
            <?=Html::activeDropDownList($model , 'types' , \common\models\TechnologyTypes::getSelectTechnologytypes() , ['class' => 'form-control width_auto'])?>
    ...
    <div class="form-group">
        ...
        <div class="controls col-sm-9 col-md-11">
            <?=Html::activeInput('text',$model,'source',['class'=>'form-control']);?>
    ...
    <div class="form-group">
        ...
        <div class="controls col-sm-9 col-md-11">
            <?=Html::activeInput('text', $model, 'readcount',['class'=>'form-control']);?>
